...
cd "/home/user/birc-contest/"
     docker run --rm -v "$(pwd):/workspace" -w /workspace lucas0423/latex-devcontainer:slim xelatex problem.tex
     docker run --rm -v "$(pwd):/workspace" -w /workspace lucas0423/latex-devcontainer:slim xelatex problem.tex  # 第二次
```
...
{
  "name": "LaTeX",
  "image": "lucas0423/latex-devcontainer:slim",
  "customizations": {
    "vscode": {
      "extensions": ["James-Yu.latex-workshop"]
    }
