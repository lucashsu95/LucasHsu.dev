  ...
  return [
    {
      ...
      items: [
        ...
        { text: 'Day 5: 陣列 Array', link: '/javascript/Days/Day5', activeMatch: '/javascript/Days/Day5' },
        { text: 'Day 6: 物件 Object', link: '/javascript/Days/Day6', activeMatch: '/javascript/Days/Day6' },
        { text: 'Day 7: 函數 Function', link: '/javascript/Days/Day7', activeMatch: '/javascript/Days/Day7' },
        { text: 'Day 8: 字串方法 String', link: '/javascript/Days/Day8', activeMatch: '/javascript/Days/Day8' },
        { text: 'Day 9: DOM 操作', link: '/javascript/Days/Day9', activeMatch: '/javascript/Days/Day9' },
        { text: 'Day 10: 事件處理 Event', link: '/javascript/Days/Day10', activeMatch: '/javascript/Days/Day10' },
