  ...
  return [
    ...
    },
    {
      ...
      items: [
        ...
        { text: "SQL 視窗函數", link: "/database/sql/sql-window-functions", activeMatch: "/database/sql/sql-window-functions" },
        { text: "排名函數（ROW_NUMBER、RANK）", link: "/database/sql/sql-window-functions-ranking", activeMatch: "/database/sql/sql-window-functions-ranking" },
        { text: "偏移函數（LAG、LEAD）", link: "/database/sql/sql-window-functions-offset", activeMatch: "/database/sql/sql-window-functions-offset" },
        { text: "聚合函數與視窗框", link: "/database/sql/sql-window-functions-aggregate", activeMatch: "/database/sql/sql-window-functions-aggregate" },
        { text: "實際範例與練習", link: "/database/sql/sql-window-functions-examples", activeMatch: "/database/sql/sql-window-functions-examples" },
