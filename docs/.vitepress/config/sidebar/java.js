    ...
    return [
        {
            ...
            items: [
                ...
                { text: "Day4 - Java 的三大主角 上文", link: "java/basic/class-object-part-1", activeMatch: "java/basic/class-object-part-1" },
                { text: "Day5 - Java 的三大主角 下文", link: "java/basic/class-object-part-2", activeMatch: "java/basic/class-object-part-2" },
                { text: "Day6 - HashSet & TreeSet", link: "java/basic/HashSetTreeSet", activeMatch: "java/basic/HashSetTreeSet" },
                { text: "Day7 - JavaStream常見的操作", link: "java/basic/JavaStream常見的操作", activeMatch: "java/basic/JavaStream常見的操作" },
