...
<span class="line"><span>不正確</span></span>
<span class="line"><span>不正確</span></span>
<span class="line"><span>不正確</span></span></code></pre></div><hr>`,72);function r(v,u,b,k,g,m){const a=t("VPNolebaseInlineLinkPreview");return c(),n("div",null,[h,e("p",null,[p(a,{href:"./字串10題ans"},{default:l(()=>[o("看答案")]),_:1})])])}const C=s(d,[["render",r]]);export{q as __pageData,C as default};
